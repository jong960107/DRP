				...
				<div class="card-body">
					...
					<div class="form-group">
						<div class="text-right">
							<a href="${root }board/readFun?boardInfoBeanIdx2=${boardInfoBeanIdx2}" class="btn btn-primary">목록보기</a>
							<c:if test="${loginUserBean.user_idx == readContentBean.content_writer_idx }">
							<a href="${root }board/modifyFun?boardInfoBeanIdx2=${boardInfoBeanIdx2}" class="btn btn-info">수정하기</a>
