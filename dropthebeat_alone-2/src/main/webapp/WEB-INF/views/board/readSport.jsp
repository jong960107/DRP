				...
				<div class="card-body">
					...
					<div class="form-group">
						<div class="text-right">
							<a href="${root }board/readSport?boardInfoBeanIdx4=${boardInfoBeanIdx4}" class="btn btn-primary">목록보기</a>
							<c:if test="${loginUserBean.user_idx == readContentBean.content_writer_idx }">
							<a href="${root }board/modifySport?boardInfoBeanIdx4=${boardInfoBeanIdx4}" class="btn btn-info">수정하기</a>
