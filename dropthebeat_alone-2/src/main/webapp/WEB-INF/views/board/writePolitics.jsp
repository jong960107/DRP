	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="card shadow">
				<div class="card-body">
					<form:form action="${root }board/writePoliticsSuccess" method="post" modelAttribute="writeContentBean" enctype="multipart/form-data">
					...
					<div class="form-group">
						<form:label path="upload_file">첨부</form:label>
