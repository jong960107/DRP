				...
				<div class="card-body">
					<form:form action="${root }board/modifyPro" method="post" modelAttribute="readContentBean" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<form:input path="content_subject" class="form-control"></form:input>
						...
						<div class="form-group">
							<div class="text-right">
								<form:button class="btn btn-primary">수정완료</form:button>
											<a href="${root }board/readFree?boardInfoBeanIdx1=${boardInfoBeanIdx1}&content_idx=${content_idx}" class="btn btn-info">취소</a>
							</div>
						</div>
					</form:form>
				</div>
